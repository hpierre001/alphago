...
class myPlayer(PlayerInterface):
    ...
    def getPlayerMove(self):
        ...
        probabilities = np.random.uniform(size=Goban.Board._BOARDSIZE * Goban.Board._BOARDSIZE  + 1)
        ...
        move = np.random.choice(range(Goban.Board._BOARDSIZE * Goban.Board._BOARDSIZE  + 1), p=probabilities)
        # Correct number for PASS
        if move == Goban.Board._BOARDSIZE * Goban.Board._BOARDSIZE:
            move = -1
